...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (currentUser.changePasswordAfter(decoded.iat)) return new AppError('User recently changed password! Please log in again!', 401);
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    const resetURL = `${req.protocol}://${req.get('host')}/reset/?resetToken=${resetToken}`;
